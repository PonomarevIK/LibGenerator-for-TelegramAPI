...
class User:
    ...
    :attribute is_premium: True, if this user is a Telegram Premium user
    :attribute added_to_attachment_menu: True, if this user added the bot to the attachment menu
    ...
    def __init__(self, json):
        ...
        if "is_premium" in json:
            self.is_premium = bool(json["is_premium"])
        if "added_to_attachment_menu" in json:
            self.added_to_attachment_menu = bool(json["added_to_attachment_menu"])
...
class Chat:
    ...
    :attribute join_to_send_messages: True, if users need to join the supergroup before they can send messages. Returned only in getChat.
    :attribute join_by_request: True, if all users directly joining the supergroup need to be approved by supergroup administrators. Returned only in getChat.
    ...
    def __init__(self, json):
        ...
        if "join_to_send_messages" in json:
            self.join_to_send_messages = bool(json["join_to_send_messages"])
        if "join_by_request" in json:
            self.join_by_request = bool(json["join_by_request"])
...
class Message:
    ...
    :attribute text: For text messages, the actual UTF-8 text of the message
    ...
    :attribute caption: Caption for the animation, audio, document, photo, video or voice
...
class InlineKeyboardButton:
    ...
    :attribute login_url: An HTTPS URL used to automatically authorize the user. Can be used as a replacement for the Telegram Login Widget.
...
class Sticker:
    ...
    :attribute premium_animation: Premium animation for the sticker, if the sticker is premium
    ...
    def __init__(self, json):
        ...
        if "premium_animation" in json:
            self.premium_animation = File(json["premium_animation"])
