...
def getUpdates(
    ...
    response = requests.get(
        API_URL.format(token=token, method=getUpdates), params=request_params
    ).json()
    if not response["ok"]:
...
def setWebhook() -> bool:
    ...
    response = requests.get(
        API_URL.format(token=token, method=setWebhook), params=request_params
    ).json()
    if not response["ok"]:
        raise requests.exceptions.RequestException(
            "Error {errno}: {error}".format(
...
def deleteWebhook(drop_pending_updates: bool = None) -> bool:
    ...
    response = requests.get(
        API_URL.format(token=token, method=deleteWebhook), params=request_params
    ).json()
    if not response["ok"]:
        raise requests.exceptions.RequestException(
            "Error {errno}: {error}".format(
...
def getWebhookInfo() -> WebhookInfo:
    ...
    response = requests.get(
        API_URL.format(token=token, method=getWebhookInfo), params=request_params
    ).json()
    if not response["ok"]:
        raise requests.exceptions.RequestException(
            "Error {errno}: {error}".format(
...
def getMe() -> User:
    ...
    response = requests.get(
        API_URL.format(token=token, method=getMe), params=request_params
    ).json()
    if not response["ok"]:
        raise requests.exceptions.RequestException(
            "Error {errno}: {error}".format(
...
def logOut() -> bool:
    ...
    response = requests.get(
        API_URL.format(token=token, method=logOut), params=request_params
    ).json()
    if not response["ok"]:
        raise requests.exceptions.RequestException(
            "Error {errno}: {error}".format(
...
def close() -> bool:
    ...
    response = requests.get(
        API_URL.format(token=token, method=close), params=request_params
    ).json()
    if not response["ok"]:
        raise requests.exceptions.RequestException(
            "Error {errno}: {error}".format(
...
def sendMessage(
    ...
    response = requests.get(
        API_URL.format(token=token, method=sendMessage), params=request_params
    ).json()
    if not response["ok"]:
        raise requests.exceptions.RequestException(
            "Error {errno}: {error}".format(
...
def forwardMessage(
    ...
    response = requests.get(
        API_URL.format(token=token, method=forwardMessage), params=request_params
    ).json()
    if not response["ok"]:
        raise requests.exceptions.RequestException(
            "Error {errno}: {error}".format(
...
def copyMessage(
    ...
    response = requests.get(
        API_URL.format(token=token, method=copyMessage), params=request_params
    ).json()
    if not response["ok"]:
        raise requests.exceptions.RequestException(
            "Error {errno}: {error}".format(
...
def sendPhoto(
    ...
    response = requests.get(
        API_URL.format(token=token, method=sendPhoto), params=request_params
    ).json()
    if not response["ok"]:
        raise requests.exceptions.RequestException(
            "Error {errno}: {error}".format(
...
def sendAudio() -> Message:
    ...
    response = requests.get(
        API_URL.format(token=token, method=sendAudio), params=request_params
    ).json()
    if not response["ok"]:
        raise requests.exceptions.RequestException(
            "Error {errno}: {error}".format(
...
def sendDocument(
    ...
    :param thumb: Thumbnail of the file sent; can be ignored if thumbnail generation for the file is supported server-side. The thumbnail should be in JPEG format and less than 200 kB in size. A thumbnail's width and height should not exceed 320. Ignored if the file is not uploaded using multipart/form-data. Thumbnails can't be reused and can be only uploaded as a new file, so you can pass “attach://<file_attach_name>” if the thumbnail was uploaded using multipart/form-data under <file_attach_name>. More information on Sending Files »
    ...
    response = requests.get(
        API_URL.format(token=token, method=sendDocument), params=request_params
    ).json()
    if not response["ok"]:
        raise requests.exceptions.RequestException(
            "Error {errno}: {error}".format(
...
def sendVideo(
    ...
    response = requests.get(
        API_URL.format(token=token, method=sendVideo), params=request_params
    ).json()
    if not response["ok"]:
        raise requests.exceptions.RequestException(
            "Error {errno}: {error}".format(
...
def sendAnimation(
    ...
    response = requests.get(
        API_URL.format(token=token, method=sendAnimation), params=request_params
    ).json()
    if not response["ok"]:
        raise requests.exceptions.RequestException(
            "Error {errno}: {error}".format(
...
def sendVoice(
    ...
    response = requests.get(
        API_URL.format(token=token, method=sendVoice), params=request_params
    ).json()
    if not response["ok"]:
        raise requests.exceptions.RequestException(
            "Error {errno}: {error}".format(
...
def sendVideoNote(
    ...
    response = requests.get(
        API_URL.format(token=token, method=sendVideoNote), params=request_params
    ).json()
    if not response["ok"]:
        raise requests.exceptions.RequestException(
            "Error {errno}: {error}".format(
...
def sendMediaGroup(
    ...
    response = requests.get(
        API_URL.format(token=token, method=sendMediaGroup), params=request_params
    ).json()
    if not response["ok"]:
        raise requests.exceptions.RequestException(
            "Error {errno}: {error}".format(
...
def sendLocation(
    ...
    response = requests.get(
        API_URL.format(token=token, method=sendLocation), params=request_params
    ).json()
    if not response["ok"]:
        raise requests.exceptions.RequestException(
            "Error {errno}: {error}".format(
...
def editMessageLiveLocation(
    ...
    response = requests.get(
        API_URL.format(token=token, method=editMessageLiveLocation),
...
def stopMessageLiveLocation(
    ...
    response = requests.get(
        API_URL.format(token=token, method=stopMessageLiveLocation),
        params=request_params,
    ).json()
    if not response["ok"]:
        raise requests.exceptions.RequestException(
...
def sendVenue(
    ...
    response = requests.get(
        API_URL.format(token=token, method=sendVenue), params=request_params
    ).json()
    if not response["ok"]:
        raise requests.exceptions.RequestException(
            "Error {errno}: {error}".format(
...
def sendContact(
    ...
    response = requests.get(
        API_URL.format(token=token, method=sendContact), params=request_params
    ).json()
    if not response["ok"]:
        raise requests.exceptions.RequestException(
            "Error {errno}: {error}".format(
...
def sendPoll(
    ...
    response = requests.get(
        API_URL.format(token=token, method=sendPoll), params=request_params
    ).json()
    if not response["ok"]:
        raise requests.exceptions.RequestException(
            "Error {errno}: {error}".format(
...
def sendDice(
    ...
    response = requests.get(
        API_URL.format(token=token, method=sendDice), params=request_params
    ).json()
    if not response["ok"]:
        raise requests.exceptions.RequestException(
            "Error {errno}: {error}".format(
...
def sendChatAction() -> bool:
    ...
    response = requests.get(
        API_URL.format(token=token, method=sendChatAction), params=request_params
    ).json()
    if not response["ok"]:
        raise requests.exceptions.RequestException(
            "Error {errno}: {error}".format(
...
def getUserProfilePhotos(
    user_id: int, offset: int = None, limit: int = None
) -> UserProfilePhotos:
    ...
    response = requests.get(
        API_URL.format(token=token, method=getUserProfilePhotos), params=request_params
    ).json()
    if not response["ok"]:
        raise requests.exceptions.RequestException(
            "Error {errno}: {error}".format(
...
def getFile(file_id: str) -> File:
    ...
    response = requests.get(
        API_URL.format(token=token, method=getFile), params=request_params
    ).json()
    if not response["ok"]:
        raise requests.exceptions.RequestException(
            "Error {errno}: {error}".format(
...
def banChatMember(
    ...
    response = requests.get(
        API_URL.format(token=token, method=banChatMember), params=request_params
    ).json()
    if not response["ok"]:
        raise requests.exceptions.RequestException(
            "Error {errno}: {error}".format(
...
def unbanChatMember(
    chat_id: int | str, user_id: int, only_if_banned: bool = None
) -> bool:
    ...
    response = requests.get(
        API_URL.format(token=token, method=unbanChatMember), params=request_params
    ).json()
    if not response["ok"]:
        raise requests.exceptions.RequestException(
            "Error {errno}: {error}".format(
...
def restrictChatMember(
    ...
    response = requests.get(
        API_URL.format(token=token, method=restrictChatMember), params=request_params
    ).json()
    if not response["ok"]:
        raise requests.exceptions.RequestException(
            "Error {errno}: {error}".format(
...
def promoteChatMember(
    ...
    response = requests.get(
        API_URL.format(token=token, method=promoteChatMember), params=request_params
    ).json()
    if not response["ok"]:
        raise requests.exceptions.RequestException(
            "Error {errno}: {error}".format(
...
def setChatAdministratorCustomTitle(
    chat_id: int | str, user_id: int, custom_title: str
) -> bool:
    ...
    response = requests.get(
        API_URL.format(token=token, method=setChatAdministratorCustomTitle),
        params=request_params,
    ).json()
    if not response["ok"]:
        raise requests.exceptions.RequestException(
...
def banChatSenderChat(chat_id: int | str, sender_chat_id: int) -> bool:
    ...
    response = requests.get(
        API_URL.format(token=token, method=banChatSenderChat), params=request_params
    ).json()
    if not response["ok"]:
        raise requests.exceptions.RequestException(
            "Error {errno}: {error}".format(
...
def unbanChatSenderChat(chat_id: int | str, sender_chat_id: int) -> bool:
    ...
    response = requests.get(
        API_URL.format(token=token, method=unbanChatSenderChat), params=request_params
    ).json()
    if not response["ok"]:
        raise requests.exceptions.RequestException(
            "Error {errno}: {error}".format(
...
def setChatPermissions(chat_id: int | str, permissions: ChatPermissions) -> bool:
    ...
    response = requests.get(
        API_URL.format(token=token, method=setChatPermissions), params=request_params
    ).json()
    if not response["ok"]:
        raise requests.exceptions.RequestException(
            "Error {errno}: {error}".format(
...
def exportChatInviteLink(chat_id: int | str) -> str:
    ...
    response = requests.get(
        API_URL.format(token=token, method=exportChatInviteLink), params=request_params
    ).json()
    if not response["ok"]:
        raise requests.exceptions.RequestException(
            "Error {errno}: {error}".format(
...
def createChatInviteLink(
    ...
    response = requests.get(
        API_URL.format(token=token, method=createChatInviteLink), params=request_params
    ).json()
    if not response["ok"]:
        raise requests.exceptions.RequestException(
            "Error {errno}: {error}".format(
...
def editChatInviteLink(
    ...
    response = requests.get(
        API_URL.format(token=token, method=editChatInviteLink), params=request_params
    ).json()
    if not response["ok"]:
        raise requests.exceptions.RequestException(
            "Error {errno}: {error}".format(
...
def revokeChatInviteLink(chat_id: int | str, invite_link: str) -> ChatInviteLink:
    ...
    response = requests.get(
        API_URL.format(token=token, method=revokeChatInviteLink), params=request_params
    ).json()
    if not response["ok"]:
        raise requests.exceptions.RequestException(
            "Error {errno}: {error}".format(
...
def approveChatJoinRequest(chat_id: int | str, user_id: int) -> bool:
    ...
    response = requests.get(
        API_URL.format(token=token, method=approveChatJoinRequest),
        params=request_params,
    ).json()
    if not response["ok"]:
        raise requests.exceptions.RequestException(
...
def declineChatJoinRequest(chat_id: int | str, user_id: int) -> bool:
    ...
    response = requests.get(
        API_URL.format(token=token, method=declineChatJoinRequest),
        params=request_params,
    ).json()
    if not response["ok"]:
        raise requests.exceptions.RequestException(
...
def setChatPhoto(chat_id: int | str, photo: InputFile) -> bool:
    ...
    response = requests.get(
        API_URL.format(token=token, method=setChatPhoto), params=request_params
    ).json()
    if not response["ok"]:
        raise requests.exceptions.RequestException(
            "Error {errno}: {error}".format(
...
def deleteChatPhoto(chat_id: int | str) -> bool:
    ...
    response = requests.get(
        API_URL.format(token=token, method=deleteChatPhoto), params=request_params
    ).json()
    if not response["ok"]:
        raise requests.exceptions.RequestException(
            "Error {errno}: {error}".format(
...
def setChatTitle(chat_id: int | str, title: str) -> bool:
    ...
    response = requests.get(
        API_URL.format(token=token, method=setChatTitle), params=request_params
    ).json()
    if not response["ok"]:
        raise requests.exceptions.RequestException(
            "Error {errno}: {error}".format(
...
def setChatDescription(chat_id: int | str, description: str = None) -> bool:
    ...
    response = requests.get(
        API_URL.format(token=token, method=setChatDescription), params=request_params
    ).json()
    if not response["ok"]:
        raise requests.exceptions.RequestException(
            "Error {errno}: {error}".format(
...
def pinChatMessage(
    chat_id: int | str, message_id: int, disable_notification: bool = None
) -> bool:
    ...
    response = requests.get(
        API_URL.format(token=token, method=pinChatMessage), params=request_params
    ).json()
    if not response["ok"]:
        raise requests.exceptions.RequestException(
            "Error {errno}: {error}".format(
...
def unpinChatMessage(chat_id: int | str, message_id: int = None) -> bool:
    ...
    response = requests.get(
        API_URL.format(token=token, method=unpinChatMessage), params=request_params
    ).json()
    if not response["ok"]:
        raise requests.exceptions.RequestException(
            "Error {errno}: {error}".format(
...
def unpinAllChatMessages(chat_id: int | str) -> bool:
    ...
    response = requests.get(
        API_URL.format(token=token, method=unpinAllChatMessages), params=request_params
    ).json()
    if not response["ok"]:
        raise requests.exceptions.RequestException(
            "Error {errno}: {error}".format(
...
def leaveChat(chat_id: int | str) -> bool:
    ...
    response = requests.get(
        API_URL.format(token=token, method=leaveChat), params=request_params
    ).json()
    if not response["ok"]:
        raise requests.exceptions.RequestException(
            "Error {errno}: {error}".format(
...
def getChat(chat_id: int | str) -> Chat:
    ...
    response = requests.get(
        API_URL.format(token=token, method=getChat), params=request_params
    ).json()
    if not response["ok"]:
        raise requests.exceptions.RequestException(
            "Error {errno}: {error}".format(
...
def getChatAdministrators(chat_id: int | str) -> list[ChatMember]:
    ...
    response = requests.get(
        API_URL.format(token=token, method=getChatAdministrators), params=request_params
    ).json()
    if not response["ok"]:
        raise requests.exceptions.RequestException(
            "Error {errno}: {error}".format(
...
def getChatMemberCount(chat_id: int | str) -> int:
    ...
    response = requests.get(
        API_URL.format(token=token, method=getChatMemberCount), params=request_params
    ).json()
    if not response["ok"]:
        raise requests.exceptions.RequestException(
            "Error {errno}: {error}".format(
...
def getChatMember(chat_id: int | str, user_id: int) -> ChatMember:
    ...
    response = requests.get(
        API_URL.format(token=token, method=getChatMember), params=request_params
    ).json()
    if not response["ok"]:
        raise requests.exceptions.RequestException(
            "Error {errno}: {error}".format(
...
def setChatStickerSet(chat_id: int | str, sticker_set_name: str) -> bool:
    ...
    response = requests.get(
        API_URL.format(token=token, method=setChatStickerSet), params=request_params
    ).json()
    if not response["ok"]:
        raise requests.exceptions.RequestException(
            "Error {errno}: {error}".format(
...
def deleteChatStickerSet(chat_id: int | str) -> bool:
    ...
    response = requests.get(
        API_URL.format(token=token, method=deleteChatStickerSet), params=request_params
    ).json()
    if not response["ok"]:
        raise requests.exceptions.RequestException(
            "Error {errno}: {error}".format(
...
def answerCallbackQuery() -> bool:
    ...
    response = requests.get(
        API_URL.format(token=token, method=answerCallbackQuery), params=request_params
    ).json()
    if not response["ok"]:
        raise requests.exceptions.RequestException(
            "Error {errno}: {error}".format(
...
def setMyCommands(
    commands: list[BotCommand], scope: BotCommandScope = None, language_code: str = None
) -> bool:
    ...
    response = requests.get(
        API_URL.format(token=token, method=setMyCommands), params=request_params
    ).json()
    if not response["ok"]:
        raise requests.exceptions.RequestException(
            "Error {errno}: {error}".format(
...
def deleteMyCommands(scope: BotCommandScope = None, language_code: str = None) -> bool:
    ...
    response = requests.get(
        API_URL.format(token=token, method=deleteMyCommands), params=request_params
    ).json()
    if not response["ok"]:
        raise requests.exceptions.RequestException(
            "Error {errno}: {error}".format(
...
def getMyCommands(
    scope: BotCommandScope = None, language_code: str = None
) -> list[BotCommand]:
    ...
    response = requests.get(
        API_URL.format(token=token, method=getMyCommands), params=request_params
    ).json()
    if not response["ok"]:
        raise requests.exceptions.RequestException(
            "Error {errno}: {error}".format(
...
def setChatMenuButton(chat_id: int = None, menu_button: MenuButton = None) -> bool:
    ...
    response = requests.get(
        API_URL.format(token=token, method=setChatMenuButton), params=request_params
    ).json()
    if not response["ok"]:
        raise requests.exceptions.RequestException(
            "Error {errno}: {error}".format(
...
def getChatMenuButton(chat_id: int = None) -> MenuButton:
    ...
    response = requests.get(
        API_URL.format(token=token, method=getChatMenuButton), params=request_params
    ).json()
    if not response["ok"]:
        raise requests.exceptions.RequestException(
            "Error {errno}: {error}".format(
...
def setMyDefaultAdministratorRights(
    rights: ChatAdministratorRights = None, for_channels: bool = None
) -> bool:
    ...
    response = requests.get(
        API_URL.format(token=token, method=setMyDefaultAdministratorRights),
        params=request_params,
    ).json()
    if not response["ok"]:
        raise requests.exceptions.RequestException(
...
def getMyDefaultAdministratorRights(
    ...
    response = requests.get(
        API_URL.format(token=token, method=getMyDefaultAdministratorRights),
        params=request_params,
    ).json()
    if not response["ok"]:
        raise requests.exceptions.RequestException(
...
def editMessageText(
    ...
    response = requests.get(
        API_URL.format(token=token, method=editMessageText), params=request_params
    ).json()
    if not response["ok"]:
        raise requests.exceptions.RequestException(
            "Error {errno}: {error}".format(
...
def editMessageCaption(
    ...
    response = requests.get(
        API_URL.format(token=token, method=editMessageCaption), params=request_params
    ).json()
    if not response["ok"]:
        raise requests.exceptions.RequestException(
            "Error {errno}: {error}".format(
...
def editMessageMedia(
    ...
    response = requests.get(
        API_URL.format(token=token, method=editMessageMedia), params=request_params
    ).json()
    if not response["ok"]:
        raise requests.exceptions.RequestException(
            "Error {errno}: {error}".format(
...
def editMessageReplyMarkup(
    ...
    response = requests.get(
        API_URL.format(token=token, method=editMessageReplyMarkup),
        params=request_params,
    ).json()
    if not response["ok"]:
        raise requests.exceptions.RequestException(
...
def stopPoll(
    chat_id: int | str, message_id: int, reply_markup: InlineKeyboardMarkup = None
) -> Poll:
    ...
    response = requests.get(
        API_URL.format(token=token, method=stopPoll), params=request_params
    ).json()
    if not response["ok"]:
        raise requests.exceptions.RequestException(
            "Error {errno}: {error}".format(
...
def deleteMessage(chat_id: int | str, message_id: int) -> bool:
    ...
    response = requests.get(
        API_URL.format(token=token, method=deleteMessage), params=request_params
    ).json()
    if not response["ok"]:
        raise requests.exceptions.RequestException(
            "Error {errno}: {error}".format(
...
def sendSticker(
    ...
    :param chat_id: Unique identifier for the target chat or username of the target channel (in the format @channelusername)
    :param sticker: Sticker to send. Pass a file_id as String to send a file that exists on the Telegram servers (recommended), pass an HTTP URL as a String for Telegram to get a .WEBP file from the Internet, or upload a new one using multipart/form-data. More information on Sending Files »
    :param disable_notification: Sends the message silently. Users will receive a notification with no sound.
    :param protect_content: Protects the contents of the sent message from forwarding and saving
    :param reply_to_message_id: If the message is a reply, ID of the original message
    :param allow_sending_without_reply: Pass True, if the message should be sent even if the specified replied-to message is not found
    ...
    response = requests.get(
        API_URL.format(token=token, method=sendSticker), params=request_params
    ).json()
    if not response["ok"]:
        raise requests.exceptions.RequestException(
            "Error {errno}: {error}".format(
...
def getStickerSet(name: str) -> StickerSet:
    ...
    response = requests.get(
        API_URL.format(token=token, method=getStickerSet), params=request_params
    ).json()
    if not response["ok"]:
        raise requests.exceptions.RequestException(
            "Error {errno}: {error}".format(
...
def uploadStickerFile(user_id: int, png_sticker: InputFile) -> File:
    ...
    :param png_sticker: PNG image with the sticker, must be up to 512 kilobytes in size, dimensions must not exceed 512px, and either width or height must be exactly 512px. More information on Sending Files »"""
    request_params = {}
    request_params["user_id"] = user_id
    request_params["png_sticker"] = png_sticker.json

    response = requests.get(
        API_URL.format(token=token, method=uploadStickerFile), params=request_params
    ).json()
    if not response["ok"]:
        raise requests.exceptions.RequestException(
            "Error {errno}: {error}".format(
...
def createNewStickerSet(
    ...
    response = requests.get(
        API_URL.format(token=token, method=createNewStickerSet), params=request_params
    ).json()
    if not response["ok"]:
        raise requests.exceptions.RequestException(
            "Error {errno}: {error}".format(
...
def addStickerToSet(
    ...
    response = requests.get(
        API_URL.format(token=token, method=addStickerToSet), params=request_params
    ).json()
    if not response["ok"]:
        raise requests.exceptions.RequestException(
            "Error {errno}: {error}".format(
...
def setStickerPositionInSet(sticker: str, position: int) -> bool:
    ...
    response = requests.get(
        API_URL.format(token=token, method=setStickerPositionInSet),
        params=request_params,
    ).json()
    if not response["ok"]:
        raise requests.exceptions.RequestException(
...
def deleteStickerFromSet(sticker: str) -> bool:
    ...
    response = requests.get(
        API_URL.format(token=token, method=deleteStickerFromSet), params=request_params
    ).json()
    if not response["ok"]:
        raise requests.exceptions.RequestException(
            "Error {errno}: {error}".format(
...
def setStickerSetThumb(name: str, user_id: int, thumb: InputFile | str = None) -> bool:
    ...
    response = requests.get(
        API_URL.format(token=token, method=setStickerSetThumb), params=request_params
    ).json()
    if not response["ok"]:
        raise requests.exceptions.RequestException(
            "Error {errno}: {error}".format(
...
def answerInlineQuery(
    ...
    response = requests.get(
        API_URL.format(token=token, method=answerInlineQuery), params=request_params
    ).json()
    if not response["ok"]:
        raise requests.exceptions.RequestException(
            "Error {errno}: {error}".format(
...
def answerWebAppQuery(
    web_app_query_id: str, result: InlineQueryResult
) -> SentWebAppMessage:
    ...
    response = requests.get(
        API_URL.format(token=token, method=answerWebAppQuery), params=request_params
    ).json()
    if not response["ok"]:
        raise requests.exceptions.RequestException(
            "Error {errno}: {error}".format(
...
def sendInvoice(
    ...
    response = requests.get(
        API_URL.format(token=token, method=sendInvoice), params=request_params
    ).json()
    if not response["ok"]:
        raise requests.exceptions.RequestException(
            "Error {errno}: {error}".format(
...
def answerShippingQuery(
    ...
    response = requests.get(
        API_URL.format(token=token, method=answerShippingQuery), params=request_params
    ).json()
    if not response["ok"]:
        raise requests.exceptions.RequestException(
            "Error {errno}: {error}".format(
...
def answerPreCheckoutQuery(
    pre_checkout_query_id: str, ok: bool, error_message: str = None
) -> bool:
    ...
    response = requests.get(
        API_URL.format(token=token, method=answerPreCheckoutQuery),
        params=request_params,
    ).json()
    if not response["ok"]:
        raise requests.exceptions.RequestException(
...
def setPassportDataErrors() -> bool:
    ...
    response = requests.get(
        API_URL.format(token=token, method=setPassportDataErrors), params=request_params
    ).json()
    if not response["ok"]:
        raise requests.exceptions.RequestException(
            "Error {errno}: {error}".format(
...
def sendGame(
    ...
    response = requests.get(
        API_URL.format(token=token, method=sendGame), params=request_params
    ).json()
    if not response["ok"]:
        raise requests.exceptions.RequestException(
            "Error {errno}: {error}".format(
...
def setGameScore(
    ...
    response = requests.get(
        API_URL.format(token=token, method=setGameScore), params=request_params
    ).json()
    if not response["ok"]:
        raise requests.exceptions.RequestException(
            "Error {errno}: {error}".format(
...
def getGameHighScores() -> list[GameHighScore]:
    ...
    response = requests.get(
        API_URL.format(token=token, method=getGameHighScores), params=request_params
    ).json()
    if not response["ok"]:
        raise requests.exceptions.RequestException(
            "Error {errno}: {error}".format(
